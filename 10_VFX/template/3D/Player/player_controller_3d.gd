...
@export_subgroup("Grayscale")
@export var OHG_amount : float = 0.9
@export var OHG_fade_in : float = 0.2
@export var OHG_wait_time : float = 0.5
@export var OHG_fade_out : float = 0.5

@export_group("Abilities")
@export_subgroup("Hologram")
@export var hologram_material : Material
@export var hologram_distance : float = 3
@export var hologram_amount_max : float = 2
