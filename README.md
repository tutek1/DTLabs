# DTLabs
A repository for the source files of the Godot labs used by the HRY course on CTU FEE.
...
4. Go into the `export` folder: `cd .\export\`
5. Host the codelab locally using `claat serve`